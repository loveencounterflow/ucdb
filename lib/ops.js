(function() {
  'use strict';
  var alert, debug, help, info, log, urge, warn, whisper;
  ...
  (jQuery('document')).ready(async function() {
    ...
    pathdata_from_glyph = async function(glyph) {
      var rsp;
    ...
    log('^ucdb/ops@6672^ pathdata', ((await pathdata_from_glyph('國'))).slice(0, 100) + '...');
    return log('^ucdb/ops@6672^ pathdata', ((await pathdata_from_glyph('鼎'))).slice(0, 100) + '...');
  });
