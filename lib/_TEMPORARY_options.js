(function() {
  ...
  module.exports = options = {
    //.........................................................................................................
    texinputs: {
      routes: ['./node_modules/cxltx-styles/styles//', './tex-inputs//']
    },
    //.........................................................................................................
    content: {
    ...
    entities: {
      ...
      /* thin constant space */'ccspc': {
        type: 'tex',
        value: '\\ccspc{}'
      },
      /* CJK constant space */'hfill': {
        type: 'tex',
        value: '\\hfill{}'
      },
      /* medium hfill */'%': {
      ...
      /* LaTeX logo */'identical': {
        type: 'tex',
        value: '{\\mktsFontfileHanamina{}≡}'
      },
      'similar': {
        type: 'tex',
        value: '{\\mktsFontfileHanamina{}≋}'
      ...
      /* 6 Non-Breaking Spaces */'lt': {
        type: 'tex',
        value: '<'
      },
      /* Left Pointy Bracket */'gt': {
        type: 'tex',
        value: '>'
      },
      /* Right Pointy Bracket */'bt': {
        type: 'tex',
        value: '`'
      },
      /* backtick */'3lines': {
      ...
      /* 3 lines */'deleatur': {
        type: 'tex',
        value: '{\\mktsFontfileSunexta{}₰}'
      },
      // ⪧
      // Black right-pointing pointer: ►
      /* Deleatur/Denarius */'ulsymbolr': {
        type: 'tex',
        value: "\\makebox[\\mktsLineheight][r]{{\\mktsFontfileLmromantenregular{}•}}"
      },
      'ulsymbol': {
        type: 'tex',
        value: "\\makebox[\\mktsLineheight][l]{{\\mktsFontfileLmromantenregular{}•}}"
      },
      ...
      'Glyphs': {
        type: 'tex',
        value: '\\mktsWPillbox{G}'
      },
      'Characters': {
        type: 'tex',
        value: '\\mktsWPillbox{Z}'
      },
      'Quasi': {
        type: 'tex',
        value: '\\mktsWPillbox{Q}'
      },
      'Clusters': {
        type: 'tex',
        value: '\\mktsWPillbox{C}'
      },
      'Factors': {
        type: 'tex',
        value: '\\mktsWPillbox{F}'
      },
      'Aggregates': {
        type: 'tex',
        value: '\\mktsWPillbox{A}'
      },
      'Traits': {
        type: 'tex',
        value: '\\mktsWPillbox{T}'
      },
      'repetitive': {
        type: 'tex',
        value: '\\mktsWPillbox{r}'
      },
      'simplex': {
        type: 'tex',
        value: '\\mktsWPillbox{s}'
      },
      'complex': {
        type: 'tex',
        value: '\\mktsWPillbox{x}'
      },
      'sC': {
        type: 'tex',
        value: '\\mktsWPillbox{sC}'
      },
      'sA': {
        type: 'tex',
        value: '\\mktsWPillbox{sA}'
      },
      'sT': {
        type: 'tex',
        value: '\\mktsWPillbox{sT}'
      },
      'xC': {
        type: 'tex',
        value: '\\mktsWPillbox{xC}'
      },
      'xA': {
        type: 'tex',
        value: '\\mktsWPillbox{xA}'
      },
      'xT': {
        type: 'tex',
        value: '\\mktsWPillbox{xT}'
      },
      'rC': {
        type: 'tex',
        value: '\\mktsWPillbox{rC}'
      },
      'rA': {
        type: 'tex',
        value: '\\mktsWPillbox{rA}'
      },
      'rT': {
        type: 'tex',
        value: '\\mktsWPillbox{rT}'
      },
      //.......................................................................................................
      'readC': {
        type: 'tex',
        value: '\\mktsCWPillbox{C}'
      },
      'readK': {
        type: 'tex',
        value: '\\mktsCWPillbox{K}'
      },
      'readJ': {
        type: 'tex',
        value: '\\mktsCWPillbox{J}'
      },
      'readY': {
        type: 'tex',
        value: '\\mktsCWPillbox{Y}'
      },
      'readE': {
        type: 'tex',
        value: '\\mktsCWPillbox{E}'
      }
    },
      ...
      files: [
        {
          ...
          texname: 'cuyuansf',
          filename: 'CTCuYuanSF-repaired.ttf'
        },
        {
          texname: 'mktsFontfileKouonea',
          subfolder: 'ochiai-oracle-bone-inscriptions',
          filename: 'Kou_1A++.ttf'
        },
        {
          texname: 'mktsFontfileHycuzhuanf',
          subfolder: 'hanyi',
          filename: 'HYCuZhuanF.TTF'
        },
        {
          texname: 'mktsFontfileEbasninetwoseven',
          subfolder: 'seal',
          filename: 'ebas927.ttf'
        },
        {
          texname: 'mktsFontfileBabelstonehan',
          filename: 'BabelStoneHan.ttf'
        },
        {
          texname: 'mktsFontfileBiaukai',
          filename: 'BiauKai.ttf'
        },
        {
          texname: 'mktsFontfileCwtexqfangsongmedium',
          filename: 'cwTeXQFangsong-Medium.ttf'
        },
        {
          texname: 'mktsFontfileCwtexqheibold',
          filename: 'cwTeXQHei-Bold.ttf'
        },
        {
          texname: 'mktsFontfileCwtexqkaimedium',
          filename: 'cwTeXQKai-Medium.ttf'
        },
        {
          texname: 'mktsFontfileCwtexqmingmedium',
          filename: 'cwTeXQMing-Medium.ttf'
        },
        {
          texname: 'mktsFontfileCwtexqyuanmedium',
          filename: 'cwTeXQYuan-Medium.ttf'
        },
        {
          texname: 'mktsFontfileDejavusans',
          filename: 'DejaVuSans.ttf'
        },
        {
          texname: 'mktsFontfileDejavusansbold',
          filename: 'DejaVuSans-Bold.ttf'
        },
        {
          texname: 'mktsFontfileDejavusansboldoblique',
          filename: 'DejaVuSans-BoldOblique.ttf'
        },
        {
          texname: 'mktsFontfileDejavusanscondensed',
          filename: 'DejaVuSansCondensed.ttf'
        },
        {
          texname: 'mktsFontfileDejavusanscondensedbold',
          filename: 'DejaVuSansCondensed-Bold.ttf'
        },
        {
          texname: 'mktsFontfileDejavusanscondensedboldoblique',
          filename: 'DejaVuSansCondensed-BoldOblique.ttf'
        },
        {
          texname: 'mktsFontfileDejavusanscondensedoblique',
          filename: 'DejaVuSansCondensed-Oblique.ttf'
        },
        {
          texname: 'mktsFontfileDejavusansmono',
          filename: 'DejaVuSansMono.ttf'
        },
        {
          texname: 'mktsFontfileDejavusansmonobold',
          filename: 'DejaVuSansMono-Bold.ttf'
        },
        {
          texname: 'mktsFontfileDejavusansmonoboldoblique',
          filename: 'DejaVuSansMono-BoldOblique.ttf'
        },
        {
          texname: 'mktsFontfileDejavusansmonooblique',
          filename: 'DejaVuSansMono-Oblique.ttf'
        },
        {
          texname: 'mktsFontfileDejavusansoblique',
          filename: 'DejaVuSans-Oblique.ttf'
        },
        {
          texname: 'mktsFontfileDejavuserif',
          filename: 'DejaVuSerif.ttf'
        },
        {
          texname: 'mktsFontfileDejavuserifbold',
          filename: 'DejaVuSerif-Bold.ttf'
        },
        {
          texname: 'mktsFontfileDejavuserifbolditalic',
          filename: 'DejaVuSerif-BoldItalic.ttf'
        },
        {
          texname: 'mktsFontfileDejavuserifcondensed',
          filename: 'DejaVuSerifCondensed.ttf'
        },
        {
          texname: 'mktsFontfileDejavuserifcondensedbold',
          filename: 'DejaVuSerifCondensed-Bold.ttf'
        },
        {
          texname: 'mktsFontfileDejavuserifcondensedbolditalic',
          filename: 'DejaVuSerifCondensed-BoldItalic.ttf'
        },
        {
          texname: 'mktsFontfileDejavuserifcondenseditalic',
          filename: 'DejaVuSerifCondensed-Italic.ttf'
        },
        {
          texname: 'mktsFontfileDejavuserifitalic',
          filename: 'DejaVuSerif-Italic.ttf'
        },
        {
          texname: 'mktsFontfileDroidsansfallbackfull',
          filename: 'DroidSansFallbackFull.ttf'
        },
        {
          texname: 'mktsFontfileDroidsansjapanese',
          filename: 'DroidSansJapanese.ttf'
        },
        {
          texname: 'mktsFontfileEbgaramondeightitalic',
          otf: 'Numbers={Monospaced,Lining},Ligatures={Rare,Historic}',
        ...
        },
        {
          ...
          otf: 'Numbers={Monospaced,Lining}',
          filename: 'EBGaramond08-Regular.otf'
        },
        {
          texname: 'mktsFontfileEbgaramondeightsc',
          otf: 'Numbers={Monospaced,Lining},Ligatures={Rare,Historic}',
          filename: 'EBGaramondSC08-Regular.otf'
        },
        {
          texname: 'mktsFontfileEbgaramondinitials',
          otf: 'Numbers={Monospaced,Lining},Ligatures={Rare,Historic}',
          filename: 'EBGaramond-Initials.otf'
        },
        {
          texname: 'mktsFontfileEbgaramondinitialsfone',
          otf: 'Numbers={Monospaced,Lining},Ligatures={Rare,Historic}',
          filename: 'EBGaramond-InitialsF1.otf'
        },
        {
          texname: 'mktsFontfileEbgaramondinitialsftwo',
          otf: 'Numbers={Monospaced,Lining},Ligatures={Rare,Historic}',
          filename: 'EBGaramond-InitialsF2.otf'
        },
        {
          texname: 'mktsFontfileEbgaramondtwelveallsc',
          otf: 'Numbers={Monospaced,Lining},Ligatures={Rare,Historic}',
          filename: 'EBGaramond12-AllSC.otf'
        },
        {
          texname: 'mktsFontfileEbgaramondtwelvesc',
          otf: 'Numbers={Monospaced,Lining},Ligatures={Rare,Historic}',
        ...
        },
        {
          ...
          otf: 'Letters={UppercaseSmallCaps},Numbers={Monospaced,Lining}',
          filename: 'EBGaramond12-Regular.otf'
        },
        {
          texname: 'mktsFontfileEbgaramondtwelveregularSclower',
          otf: 'Letters={SmallCaps},Numbers={Monospaced,Lining}',
          filename: 'EBGaramond12-Regular.otf'
        },
        {
          texname: 'mktsFontfileEbgaramondtwelveregularScall',
          otf: 'Letters={SmallCaps,UppercaseSmallCaps},Numbers={Monospaced,Lining}',
          filename: 'EBGaramond12-Regular.otf'
        },
        {
          texname: 'mktsFontfileEbgaramondtwelveitalic',
          otf: 'Numbers={Monospaced,Lining},Ligatures={Rare,Historic}',
          filename: 'EBGaramond12-Italic.otf'
        },
        {
          texname: 'mktsFontfileEbgaramondtwelveitalicscupper',
          otf: 'Letters={UppercaseSmallCaps},Numbers={Monospaced,Lining}',
          filename: 'EBGaramond12-Italic.otf'
        },
        {
          texname: 'mktsFontfileEbgaramondtwelveitalicsclower',
          otf: 'Letters={SmallCaps},Numbers={Monospaced,Lining}',
          filename: 'EBGaramond12-Italic.otf'
        },
        {
          texname: 'mktsFontfileEbgaramondtwelveitalicscall',
          otf: 'Letters={SmallCaps,UppercaseSmallCaps},Numbers={Monospaced,Lining}',
          filename: 'EBGaramond12-Italic.otf'
        },
        {
          texname: 'mktsFontfileEpgyobld',
          filename: 'EPGYOBLD.TTF'
        },
        {
          texname: 'mktsFontfileEpgyosho',
          filename: 'EPGYOSHO.TTF'
        },
        {
          texname: 'mktsFontfileEpkaisho',
          filename: 'EPKAISHO.TTF'
        },
        {
          texname: 'mktsFontfileEpkgobld',
          filename: 'EPKGOBLD.TTF'
        },
        {
          texname: 'mktsFontfileEpkyouka',
          filename: 'EPKYOUKA.TTF'
        },
        {
          texname: 'mktsFontfileEpmarugo',
          filename: 'EPMARUGO.TTF'
        },
        {
          texname: 'mktsFontfileEpmgobld',
          filename: 'EPMGOBLD.TTF'
        },
        {
          texname: 'mktsFontfileEpminbld',
          filename: 'EPMINBLD.TTF'
        },
        {
          texname: 'mktsFontfileFandolfangregular',
          filename: 'FandolFang-Regular.otf'
        },
        {
          texname: 'mktsFontfileFandolheibold',
          filename: 'FandolHei-Bold.otf'
        },
        {
          texname: 'mktsFontfileFandolheiregular',
          filename: 'FandolHei-Regular.otf'
        },
        {
          texname: 'mktsFontfileFandolkairegular',
          filename: 'FandolKai-Regular.otf'
        },
        {
          texname: 'mktsFontfileFandolsongbold',
          filename: 'FandolSong-Bold.otf'
        },
        {
          texname: 'mktsFontfileFandolsongregular',
          filename: 'FandolSong-Regular.otf'
        },
        {
          texname: 'mktsFontfileFiracodebold',
          filename: 'FiraCode-Bold.otf'
        },
        {
          texname: 'mktsFontfileFiracodelight',
          filename: 'FiraCode-Light.otf'
        },
        {
          texname: 'mktsFontfileFiracodemedium',
          filename: 'FiraCode-Medium.otf'
        },
        {
          texname: 'mktsFontfileFiracoderegular',
          filename: 'FiraCode-Regular.otf'
        },
        {
          texname: 'mktsFontfileFiracoderetina',
          filename: 'FiraCode-Retina.otf'
        },
        {
          texname: 'mktsFontfileFlowdejavusansmono',
          filename: 'FlowDejaVuSansMono.ttf'
        },
        {
          texname: 'mktsFontfileFontsjapanesegothic',
          filename: 'fonts-japanese-gothic.ttf'
        },
        {
          texname: 'mktsFontfileFontsjapanesemincho',
          filename: 'fonts-japanese-mincho.ttf'
        },
        {
          texname: 'mktsFontfileHanamina',
          filename: 'HanaMinA.ttf'
        },
        {
          texname: 'mktsFontfileHanaminb',
          filename: 'HanaMinB.ttf'
        },
        {
          texname: 'mktsFontfileIpaexg',
          filename: 'ipaexg.ttf'
        },
        {
          texname: 'mktsFontfileIpaexm',
          filename: 'ipaexm.ttf'
        },
        {
          texname: 'mktsFontfileIpag',
          filename: 'ipag.ttf'
        },
        {
          texname: 'mktsFontfileIpagp',
          filename: 'ipagp.ttf'
        },
        {
          texname: 'mktsFontfileIpam',
          filename: 'ipam.ttf'
        },
        {
          texname: 'mktsFontfileIpamp',
          filename: 'ipamp.ttf'
        },
        {
          texname: 'mktsFontfileJizurathreeb',
          filename: 'jizura3b.ttf'
        },
        {
          texname: 'mktsFontfileJizurafourbmp',
          filename: 'jizura4bmp.ttf'
        },
        {
          texname: 'mktsFontfileKai',
          filename: 'Kai.ttf'
        },
        {
          texname: 'mktsFontfileMonoidbold',
          filename: 'Monoid-Bold.ttf'
        },
        {
          texname: 'mktsFontfileMonoiditalic',
          filename: 'Monoid-Italic.ttf'
        },
        {
          texname: 'mktsFontfileMonoidregular',
          filename: 'Monoid-Regular.ttf'
        },
        {
          texname: 'mktsFontfileMonoidretina',
          filename: 'Monoid-Retina.ttf'
        },
        {
          texname: 'mktsFontfileNanumgothic',
          filename: 'NanumGothic.ttc'
        },
        {
          texname: 'mktsFontfileNanummyeongjo',
          filename: 'NanumMyeongjo.ttc'
        },
        {
          texname: 'mktsFontfileOptima',
          filename: 'Optima.ttc'
        },
        {
          texname: 'mktsFontfilePtsans',
          filename: 'PTSans.ttc'
        },
        {
          texname: 'mktsFontfileSimsun',
          filename: 'simsun.ttc'
        },
        {
          texname: 'mktsFontfileSourcecodeproblack',
          filename: 'SourceCodePro-Black.otf'
        },
        {
          texname: 'mktsFontfileSourcecodeprobold',
          filename: 'SourceCodePro-Bold.otf'
        },
        {
          texname: 'mktsFontfileSourcecodeproextralight',
          filename: 'SourceCodePro-ExtraLight.otf'
        },
        {
          texname: 'mktsFontfileSourcecodeprolight',
          filename: 'SourceCodePro-Light.otf'
        },
        {
          texname: 'mktsFontfileSourcecodepromedium',
          filename: 'SourceCodePro-Medium.otf'
        },
        {
          texname: 'mktsFontfileSourcecodeproregular',
          filename: 'SourceCodePro-Regular.otf'
        },
        {
          texname: 'mktsFontfileSourcecodeprosemibold',
          filename: 'SourceCodePro-Semibold.otf'
        },
        {
          texname: 'mktsFontfileSourcehansansbold',
          filename: 'SourceHanSans-Bold.ttc'
        },
        {
          texname: 'mktsFontfileSourcehansansextralight',
          filename: 'SourceHanSans-ExtraLight.ttc'
        },
        {
          texname: 'mktsFontfileSourcehansansheavy',
          filename: 'SourceHanSans-Heavy.ttc'
        },
        {
          texname: 'mktsFontfileSourcehansanslight',
          filename: 'SourceHanSans-Light.ttc'
        },
        {
          texname: 'mktsFontfileSourcehansansmedium',
          filename: 'SourceHanSans-Medium.ttc'
        },
        {
          texname: 'mktsFontfileSourcehansansnormal',
          filename: 'SourceHanSans-Normal.ttc'
        },
        {
          texname: 'mktsFontfileSourcehansansregular',
          filename: 'SourceHanSans-Regular.ttc'
        },
        {
          texname: 'mktsFontfileSunexta',
          filename: 'sun-exta.ttf'
        },
        {
          texname: 'mktsFontfileSunextb',
          filename: 'Sun-ExtB.ttf'
        },
        {
          texname: 'mktsFontfileSunflowerucjkxb',
          filename: 'sunflower-u-cjk-xb.ttf'
        },
        {
          texname: 'mktsFontfileTakaopgothic',
          filename: 'TakaoPGothic.ttf'
        },
        {
          texname: 'mktsFontfileUbuntub',
          filename: 'Ubuntu-B.ttf'
        },
        {
          texname: 'mktsFontfileUbuntubi',
          filename: 'Ubuntu-BI.ttf'
        },
        {
          texname: 'mktsFontfileUbuntuc',
          filename: 'Ubuntu-C.ttf'
        },
        {
          texname: 'mktsFontfileUbuntul',
          filename: 'Ubuntu-L.ttf'
        },
        {
          texname: 'mktsFontfileUbuntuli',
          filename: 'Ubuntu-LI.ttf'
        },
        {
          texname: 'mktsFontfileUbuntumonob',
          filename: 'UbuntuMono-B.ttf'
        },
        {
          texname: 'mktsFontfileUbuntumonobi',
          filename: 'UbuntuMono-BI.ttf'
        },
        {
          texname: 'mktsFontfileUbuntumonor',
          filename: 'UbuntuMono-R.ttf'
        },
        {
          texname: 'mktsFontfileUbuntumonori',
          filename: 'UbuntuMono-RI.ttf'
        },
        {
          texname: 'mktsFontfileUbuntur',
          filename: 'Ubuntu-R.ttf'
        },
        {
          texname: 'mktsFontfileUbunturi',
          filename: 'Ubuntu-RI.ttf'
        },
        {
          texname: 'mktsFontfileUkai',
          filename: 'ukai.ttc'
        },
        {
          texname: 'mktsFontfileUming',
          filename: 'uming.ttc'
        },
        {
          ...
          texname: 'mktsFontfileIosevkatermslabbolditalic',
          otf: 'CharacterVariant={15,21,3,24,19,17,23,51,46,44,34}',
          subfolder: 'iosevka-term-slab-2.0.0',
          filename: 'iosevka-term-slab-bolditalic.ttf'
        },
        {
          texname: 'mktsFontfileIosevkatermslabbold',
          otf: 'CharacterVariant={15,21,3,24,19,17,23,51,46,44,34}',
          subfolder: 'iosevka-term-slab-2.0.0',
          filename: 'iosevka-term-slab-bold.ttf'
        },
        {
          texname: 'mktsFontfileIosevkatermslabmediumitalic',
          otf: 'CharacterVariant={15,21,3,24,19,17,23,51,46,44,34}',
          subfolder: 'iosevka-term-slab-2.0.0',
          filename: 'iosevka-term-slab-mediumitalic.ttf'
        },
        {
          texname: 'mktsFontfileIosevkatermslabmedium',
          otf: 'CharacterVariant={15,21,3,24,19,17,23,51,46,44,34}',
          subfolder: 'iosevka-term-slab-2.0.0',
          filename: 'iosevka-term-slab-medium.ttf'
        },
        {
          texname: 'mktsFontfileFjallaoneregular',
          subfolder: 'Fjalla_One',
          filename: 'FjallaOne-Regular.ttf'
        },
        {
          texname: 'mktsFontfileMerriweatherblack',
          subfolder: 'Merriweather',
          filename: 'Merriweather-Black.ttf'
        },
        {
          texname: 'mktsFontfileMerriweatherblackitalic',
          subfolder: 'Merriweather',
          filename: 'Merriweather-BlackItalic.ttf'
        },
        {
          texname: 'mktsFontfileMerriweatherbold',
          subfolder: 'Merriweather',
          filename: 'Merriweather-Bold.ttf'
        },
        {
          texname: 'mktsFontfileMerriweatherbolditalic',
          subfolder: 'Merriweather',
          filename: 'Merriweather-BoldItalic.ttf'
        },
        {
          texname: 'mktsFontfileMerriweatheritalic',
          subfolder: 'Merriweather',
          filename: 'Merriweather-Italic.ttf'
        },
        {
          texname: 'mktsFontfileMerriweatherlight',
          subfolder: 'Merriweather',
          filename: 'Merriweather-Light.ttf'
        },
        {
          texname: 'mktsFontfileMerriweatherlightitalic',
          subfolder: 'Merriweather',
          filename: 'Merriweather-LightItalic.ttf'
        },
        {
          texname: 'mktsFontfileMerriweatherregular',
          subfolder: 'Merriweather',
          filename: 'Merriweather-Regular.ttf'
        },
        {
          texname: 'mktsFontfileOswaldbold',
          subfolder: 'Oswald',
          filename: 'Oswald-Bold.ttf'
        },
        {
          texname: 'mktsFontfileOswaldlight',
          subfolder: 'Oswald',
          filename: 'Oswald-Light.ttf'
        },
        {
          texname: 'mktsFontfileOswaldregular',
          subfolder: 'Oswald',
          filename: 'Oswald-Regular.ttf'
        },
        {
          texname: 'mktsFontfileRobotoblack',
          subfolder: 'Roboto',
          filename: 'Roboto-Black.ttf'
        },
        {
          texname: 'mktsFontfileRobotoblackitalic',
          subfolder: 'Roboto',
          filename: 'Roboto-BlackItalic.ttf'
        },
        {
          texname: 'mktsFontfileRobotobold',
          subfolder: 'Roboto',
          filename: 'Roboto-Bold.ttf'
        },
        {
          texname: 'mktsFontfileRobotobolditalic',
          subfolder: 'Roboto',
          filename: 'Roboto-BoldItalic.ttf'
        },
        {
          texname: 'mktsFontfileRobotoitalic',
          subfolder: 'Roboto',
          filename: 'Roboto-Italic.ttf'
        },
        {
          texname: 'mktsFontfileRobotolight',
          subfolder: 'Roboto',
          filename: 'Roboto-Light.ttf'
        },
        {
          texname: 'mktsFontfileRobotolightitalic',
          subfolder: 'Roboto',
          filename: 'Roboto-LightItalic.ttf'
        },
        {
          texname: 'mktsFontfileRobotomedium',
          subfolder: 'Roboto',
          filename: 'Roboto-Medium.ttf'
        },
        {
          texname: 'mktsFontfileRobotomediumitalic',
          subfolder: 'Roboto',
          filename: 'Roboto-MediumItalic.ttf'
        },
        {
          texname: 'mktsFontfileRobotoregular',
          subfolder: 'Roboto',
          filename: 'Roboto-Regular.ttf'
        },
        {
          texname: 'mktsFontfileRobotothin',
          subfolder: 'Roboto',
          filename: 'Roboto-Thin.ttf'
        },
        {
          texname: 'mktsFontfileRobotothinitalic',
          subfolder: 'Roboto',
          filename: 'Roboto-ThinItalic.ttf'
        },
        {
          texname: 'mktsFontfileRobotocondensedbold',
          subfolder: 'Roboto_Condensed',
          filename: 'RobotoCondensed-Bold.ttf'
        },
        {
          texname: 'mktsFontfileRobotocondensedbolditalic',
          subfolder: 'Roboto_Condensed',
          filename: 'RobotoCondensed-BoldItalic.ttf'
        },
        {
          texname: 'mktsFontfileRobotocondenseditalic',
          subfolder: 'Roboto_Condensed',
          filename: 'RobotoCondensed-Italic.ttf'
        },
        {
          texname: 'mktsFontfileRobotocondensedlight',
          subfolder: 'Roboto_Condensed',
          filename: 'RobotoCondensed-Light.ttf'
        },
        {
          texname: 'mktsFontfileRobotocondensedlightitalic',
          subfolder: 'Roboto_Condensed',
          filename: 'RobotoCondensed-LightItalic.ttf'
        },
        {
          texname: 'mktsFontfileRobotocondensedregular',
          subfolder: 'Roboto_Condensed',
          filename: 'RobotoCondensed-Regular.ttf'
        },
        {
          texname: 'mktsFontfileRobotoslabbold',
          subfolder: 'Roboto_Slab',
          filename: 'RobotoSlab-Bold.ttf'
        },
        {
          texname: 'mktsFontfileRobotoslablight',
          subfolder: 'Roboto_Slab',
          filename: 'RobotoSlab-Light.ttf'
        },
        {
          texname: 'mktsFontfileRobotoslabregular',
          subfolder: 'Roboto_Slab',
          filename: 'RobotoSlab-Regular.ttf'
        },
        {
          texname: 'mktsFontfileRobotoslabthin',
          subfolder: 'Roboto_Slab',
          filename: 'RobotoSlab-Thin.ttf'
        },
        {
          texname: 'mktsFontfileSourcesansproblack',
          subfolder: 'Source_Sans_Pro',
          filename: 'SourceSansPro-Black.ttf'
        },
        {
          texname: 'mktsFontfileSourcesansproblackitalic',
          subfolder: 'Source_Sans_Pro',
          filename: 'SourceSansPro-BlackItalic.ttf'
        },
        {
          texname: 'mktsFontfileSourcesansprobold',
          subfolder: 'Source_Sans_Pro',
          filename: 'SourceSansPro-Bold.ttf'
        },
        {
          texname: 'mktsFontfileSourcesansprobolditalic',
          subfolder: 'Source_Sans_Pro',
          filename: 'SourceSansPro-BoldItalic.ttf'
        },
        {
          texname: 'mktsFontfileSourcesansproextralight',
          subfolder: 'Source_Sans_Pro',
          filename: 'SourceSansPro-ExtraLight.ttf'
        },
        {
          texname: 'mktsFontfileSourcesansproextralightitalic',
          subfolder: 'Source_Sans_Pro',
          filename: 'SourceSansPro-ExtraLightItalic.ttf'
        },
        {
          texname: 'mktsFontfileSourcesansproitalic',
          subfolder: 'Source_Sans_Pro',
          filename: 'SourceSansPro-Italic.ttf'
        },
        {
          texname: 'mktsFontfileSourcesansprolight',
          subfolder: 'Source_Sans_Pro',
          filename: 'SourceSansPro-Light.ttf'
        },
        {
          texname: 'mktsFontfileSourcesansprolightitalic',
          subfolder: 'Source_Sans_Pro',
          filename: 'SourceSansPro-LightItalic.ttf'
        },
        {
          texname: 'mktsFontfileSourcesansproregular',
          subfolder: 'Source_Sans_Pro',
          filename: 'SourceSansPro-Regular.ttf'
        },
        {
          texname: 'mktsFontfileSourcesansprosemibold',
          subfolder: 'Source_Sans_Pro',
          filename: 'SourceSansPro-Semibold.ttf'
        },
        {
          texname: 'mktsFontfileSourcesansprosemibolditalic',
          subfolder: 'Source_Sans_Pro',
          filename: 'SourceSansPro-SemiboldItalic.ttf'
        },
        {
          texname: 'mktsFontfileStintultracondensedregular',
          subfolder: 'Stint_Ultra_Condensed',
          filename: 'StintUltraCondensed-Regular.ttf'
        },
        {
          texname: 'mktsFontfileYanonekaffeesatzbold',
          subfolder: 'Yanone_Kaffeesatz',
          filename: 'YanoneKaffeesatz-Bold.ttf'
        },
        {
          texname: 'mktsFontfileYanonekaffeesatzextralight',
          subfolder: 'Yanone_Kaffeesatz',
          filename: 'YanoneKaffeesatz-ExtraLight.ttf'
        },
        {
          texname: 'mktsFontfileYanonekaffeesatzlight',
          subfolder: 'Yanone_Kaffeesatz',
          filename: 'YanoneKaffeesatz-Light.ttf'
        },
        {
          texname: 'mktsFontfileYanonekaffeesatzregular',
          subfolder: 'Yanone_Kaffeesatz',
          filename: 'YanoneKaffeesatz-Regular.ttf'
        },
        {
          texname: 'mktsFontfilePermianslabseriftypeface',
          subfolder: 'Permian_Slab',
          filename: 'PermianSlabSerifTypeface.otf'
        },
        {
          texname: 'mktsFontfilePermianslabseriftypefacebold',
          subfolder: 'Permian_Slab',
          filename: 'PermianSlabSerifTypeface-Bold.otf'
        },
        {
          texname: 'mktsFontfilePermianslabseriftypefaceitalic',
          subfolder: 'Permian_Slab',
          filename: 'PermianSlabSerifTypeface-Italic.otf'
        },
        {
          texname: 'mktsFontfileBitterbold',
          subfolder: 'Bitter',
          filename: 'Bitter-Bold.otf'
        },
        {
          texname: 'mktsFontfileBitterbolditalic',
          subfolder: 'Bitter',
          filename: 'Bitter-BoldItalic.otf'
        },
        {
          texname: 'mktsFontfileBitteritalic',
          subfolder: 'Bitter',
          filename: 'Bitter-Italic.otf'
        },
        {
          texname: 'mktsFontfileBitterregular',
          subfolder: 'Bitter',
          filename: 'Bitter-Regular.otf'
        },
        {
          texname: 'mktsFontfileAleobold',
          subfolder: 'Aleo_font_v1.2.2/Desktop OTF',
          filename: 'Aleo-Bold.otf'
        },
        {
          texname: 'mktsFontfileAleobolditalic',
          subfolder: 'Aleo_font_v1.2.2/Desktop OTF',
          filename: 'Aleo-BoldItalic.otf'
        },
        {
          texname: 'mktsFontfileAleoitalic',
          subfolder: 'Aleo_font_v1.2.2/Desktop OTF',
          filename: 'Aleo-Italic.otf'
        },
        {
          texname: 'mktsFontfileAleolight',
          subfolder: 'Aleo_font_v1.2.2/Desktop OTF',
          filename: 'Aleo-Light.otf'
        },
        {
          texname: 'mktsFontfileAleolightitalic',
          subfolder: 'Aleo_font_v1.2.2/Desktop OTF',
          filename: 'Aleo-LightItalic.otf'
        },
        {
          texname: 'mktsFontfileAleoregular',
          subfolder: 'Aleo_font_v1.2.2/Desktop OTF',
          filename: 'Aleo-Regular.otf'
        },
        {
          texname: 'mktsFontfileUnifrakturcook',
          subfolder: 'unifraktur',
          filename: 'UnifrakturCook.ttf'
        },
        {
          texname: 'mktsFontfileUnifrakturcooklight',
          subfolder: 'unifraktur',
          filename: 'UnifrakturCook-Light.ttf'
        },
        {
          texname: 'mktsFontfileUnifrakturmaguntia',
          subfolder: 'unifraktur',
          filename: 'UnifrakturMaguntia.ttf'
        },
        {
          texname: 'mktsFontfileGltsukijifivego',
          subfolder: 'GL-Tsukiji-5go',
          filename: 'GL-Tsukiji-5go.ttf'
        },
        {
          texname: 'mktsFontfileThtshynpzero',
          subfolder: 'TH-Tshyn',
          filename: 'TH-Tshyn-P0.ttf'
        },
        {
          texname: 'mktsFontfileThtshynpone',
          subfolder: 'TH-Tshyn',
          filename: 'TH-Tshyn-P1.ttf'
        },
        {
          texname: 'mktsFontfileThtshynptwo',
          subfolder: 'TH-Tshyn',
          filename: 'TH-Tshyn-P2.ttf'
        },
        {
          texname: 'mktsFontfileNotoserifjpblack',
          subfolder: 'NotoSerifJP',
          filename: 'NotoSerifJP-Black.otf'
        },
        {
          texname: 'mktsFontfileNotoserifjpbold',
          subfolder: 'NotoSerifJP',
          filename: 'NotoSerifJP-Bold.otf'
        },
        {
          texname: 'mktsFontfileNotoserifjpextralight',
          subfolder: 'NotoSerifJP',
          filename: 'NotoSerifJP-ExtraLight.otf'
        },
        {
          texname: 'mktsFontfileNotoserifjplight',
          subfolder: 'NotoSerifJP',
          filename: 'NotoSerifJP-Light.otf'
        },
        {
          texname: 'mktsFontfileNotoserifjpmedium',
          subfolder: 'NotoSerifJP',
          filename: 'NotoSerifJP-Medium.otf'
        },
        {
          texname: 'mktsFontfileNotoserifjpregular',
          subfolder: 'NotoSerifJP',
          filename: 'NotoSerifJP-Regular.otf'
        },
        {
          texname: 'mktsFontfileNotoserifjpsemibold',
          subfolder: 'NotoSerifJP',
          filename: 'NotoSerifJP-SemiBold.otf'
        },
        {
          texname: 'mktsFontfileNotoserifcjkblack',
          subfolder: 'NotoSerifJP',
          filename: 'NotoSerifCJK-Black.ttc'
        },
        {
          texname: 'mktsFontfileThkhaaitpzero',
          subfolder: 'TH-Khaai',
          filename: 'TH-Khaai-TP0.ttf'
        },
        {
          texname: 'mktsFontfileThkhaaitptwo',
          subfolder: 'TH-Khaai',
          filename: 'TH-Khaai-TP2.ttf'
        },
        {
          texname: 'mktsFontfileHminglanr',
          subfolder: 'MingLan',
          filename: 'H-MingLan-R.ttf'
        },
        {
          texname: 'mktsFontfileHminglanb',
          subfolder: 'MingLan',
          filename: 'H-MingLan-B.ttf'
        },
        {
          texname: 'mktsFontfileRkaisubold',
          filename: 'R-Kai-SUBold.ttf'
        },
        {
          texname: 'mktsFontfileRkantingliuwnine',
          filename: 'R-KanTingLiu-W9.ttf'
        },
        {
          texname: 'mktsFontfileSushikii',
          subfolder: 'sushiki_ub',
          filename: 'sushikii.ttf'
        },
        {
          ...
          texname: 'mktsFontfileSarasabold',
          subfolder: 'sarasa-gothic-0.6.0',
          filename: 'sarasa-bold.ttc'
        },
        {
          texname: 'mktsFontfileSarasabolditalic',
          subfolder: 'sarasa-gothic-0.6.0',
          filename: 'sarasa-bolditalic.ttc'
        },
        {
          texname: 'mktsFontfileSarasaitalic',
          subfolder: 'sarasa-gothic-0.6.0',
          filename: 'sarasa-italic.ttc'
        },
        {
          texname: 'mktsFontfileSarasaregular',
          subfolder: 'sarasa-gothic-0.6.0',
          filename: 'sarasa-regular.ttc'
        },
        {
          texname: 'mktsFontfileAsanamath',
          filename: 'Asana-Math.otf'
        },
        {
          ...
          texname: 'mktsFontfileLmromantenitalic',
          home: '',
          filename: 'lmroman10-italic.otf'
        },
        {
          texname: 'mktsFontfileLmromantenregular',
          home: '',
    ...
    'tex': {
      ...
      'glyph-styles': {
        ...
        '🉠': {
          cmd: 'mktsStyleCjkRoundSymbol{🉠}',
          glyph: ''
        },
        /* TAINT dirty trick, update configuration syntax */'🉡': {
          cmd: 'mktsStyleCjkRoundSymbol{🉡}',
          glyph: ''
        },
        /* TAINT dirty trick, update configuration syntax */'🉢': {
