(function() {
  'use strict';
  var $, $async, $show, $watch, CND, FS, FSP, MIRAGE, MKNCR, PATH, PD, RCFG, SVGTTF, _drop_extension, _glob, alert, assign, badge, cast, cid_ranges, cid_ranges_by_runmode, cwd_abspath, cwd_relpath, debug, declare, echo, glob, help, here_abspath, info, isa, jr, last_of, log, mkts_fontfiles, mkts_glyph_styles, mkts_options, project_abspath, rpr, runmode, size_of, type_of, urge, validate, walk_cids_in_cid_range, warn, whisper,
    indexOf = [].indexOf;
  ...
  // FONTNICKS
  //-----------------------------------------------------------------------------------------------------------
  this.read_fontnicks = async function(me) {
