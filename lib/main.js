(function() {
  'use strict';
  var $, $async, $show, $watch, CND, FS, FSP, MIRAGE, MKNCR, PATH, PD, RCFG, SVGTTF, _drop_extension, _glob, alert, assign, badge, cast, cid_ranges, cid_ranges_by_runmode, cwd_abspath, cwd_relpath, debug, declare, echo, glob, help, here_abspath, info, isa, jr, last_of, log, mkts_glyph_styles, mkts_options, project_abspath, rpr, runmode, size_of, type_of, urge, validate, walk_cids_in_cid_range, warn, whisper,
    indexOf = [].indexOf;
  ...
  cid_ranges_by_runmode = {
    ...
    debug_cross_cjk: ['𗐑𥳑字好松一丁丂七丄丅丆万㐀㐁㐂龰龱龲龳龴龵龶龷龸龹龺龻⺶龼龽龾龿鿀鿁鿂鿃鿄鿅鿆鿇鿈鿉鿊鿋鿌鿍鿎鿏鿐鿑鿒鿓鿔鿕鿖鿗鿘鿙鿚鿛鿜鿝鿞鿟鿠鿡鿢鿣鿤鿥鿦鿧鿨鿩鿪鿫鿬鿭鿮鿯𠀀𠀁𠀂𪜀𪜁𪜂𫝀𫝁𫝂𫠠𫠡𫠢𬺰𬺱𬺲〡〢〣〤〥〦〧〨〩〸〹〺〻〼〽🉠🉡🉢🉣🉤🉥'],
  ...
  this.read_fontnicks = function(me) {
    var R, filename, fontnick, otf, ref, row;
    R = {};
    ref = me.db.configured_fontnicks_and_filenames();
    for (row of ref) {
