...
//.........................................................................................................
  ...
  this._get_pathdata = function(SVGTTF_font, cid, tag = 'use-quickscale') {
  ...
  this.populate_table_outlines = function(me) {
    var XXX_includes, XXX_sql, fontnick, fontnicks, glyphrows, i, len, row;
  ...
  this._insert_into_table_outlines = function(me, fontnick, glyphrows) {
    ...
    var SVGTTF_font, XXX_advance_scale_factor, advance, batch_size, cid, d, data, error, glyph, iclabel, line_count, pathdata, preamble, ref, ref1, tag, x;
    preamble = [];
    data = [];
    line_count = 0;
    batch_size = 5000;
    ...
    for (x of ref1) {
      ({iclabel, cid, glyph} = x);
      if ((d = this._get_pathdata(SVGTTF_font, cid, tag)) == null) {
        continue;
      }
      ({glyph, pathdata} = d);
