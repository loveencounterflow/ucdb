(function() {
  'use strict';
  var $, $async, $show, $watch, CND, FS, FSP, MIRAGE, MKNCR, PATH, PD, SVGTTF, _drop_extension, _glob, alert, assign, badge, cast, cid_ranges, cid_ranges_by_runmode, cwd_abspath, cwd_relpath, debug, declare, echo, glob, help, here_abspath, info, isa, jr, last_of, log, mkts_fontfiles, mkts_glyph_styles, mkts_options, project_abspath, rpr, runmode, size_of, type_of, urge, validate, walk_cids_in_cid_range, warn, whisper,
    indexOf = [].indexOf;
...
//.........................................................................................................
  ...
  this._insert_into_table_outlines = function(me, known_hashes, fontnick, glyphrows) {
    ...
    var SVGTTF_font, XXX_advance_scale_factor, advance, batch_size, cid, cid_hex, content, content_data, d, duplicate_count, error, false_fallback_pathdata, glyph, hash, iclabel, line_count, outlines_data, pathdata, ref, ref1, tag, x;
    outlines_data = [];
    content_data = [];
    line_count = 0;
    duplicate_count = 0;
  ...
  this._flush_outlines = function(me, content_data, outlines_data) {
    var line_count, remove_comma, sql;
    if ((content_data.length === 0) && (outlines_data.length === 0)) {
