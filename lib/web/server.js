(function() {
  'use strict';
  var $, $async, $echo, $show, $time_request, $watch, CND, COMMON, FS, FSP, HELPERS, HTTP, Koa, O, PATH, PD, SVG, TEMPLATES, TIMER, _drop_extension, _glob, _pathdata_from_outline_row, alert, assign, badge, cast, cwd_abspath, cwd_relpath, debug, declare, echo, glob, help, here_abspath, info, isa, jr, last_of, log, pathdata_from_glyph, pathdatamap_from_glyphs, project_abspath, root_router, rpr, sample_glyphs, serve, size_of, type_of, urge, validate, walk_cids_in_cid_range, warn, whisper;
  ...
  pathdatamap_from_glyphs = function(fontnick, glyphs) {
    ...
    var R, glyphs_tuple, n, outline_nr, pathdata, ref, row, shared_outline_count, sql, sql_template;
    n = glyphs.length;
    ...
    for (row of ref) {
      ({outline_nr, shared_outline_count} = row);
  ...
  SVG.slug_from_pathdatamap = function(fontnick, glyphs, pathdatamap) {
    var R, advance_x, entry, glyph, glyph_count, i, len, outline_nr, pathdata, push, shared_outline_count, width, x, x0;
    x0 = 0;
    x = 0;
...
//.........................................................................................................
    for (i = 0, len = glyphs.length; i < len; i++) {
      ...
      //.......................................................................................................
      if (entry != null) {
        ({pathdata, outline_nr, shared_outline_count} = entry);
