(function() {
  ...
  //###########################################################################################################
  var CND, COMMON, SERVER, TEACUP, UCDB, _drop_extension, alert, badge, cast, cwd_abspath, cwd_relpath, debug, help, here_abspath, info, isa, jr, log, njs_fs, njs_path, project_abspath, rpr, type_of, urge, validate, walk_cids_in_cid_range, warn, whisper;
