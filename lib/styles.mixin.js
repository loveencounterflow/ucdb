(function() {
  'use strict';
  var CND, CS, FS, FSP, PATH, VM, _drop_extension, alert, assign, badge, cast, cwd_abspath, cwd_relpath, debug, declare, echo, help, here_abspath, info, isa, jr, last_of, log, project_abspath, rpr, size_of, type_of, types, urge, validate, walk_cids_in_cid_range, warn, whisper;
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.compile_style_txt = function(me, style_txt) {
    var R, error;
    if (style_txt == null) {
      return null;
    }
...
//# sourceMappingURL=styles.mixin.js.map