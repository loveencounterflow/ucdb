(function() {
  'use strict';
  var CND, FS, FSP, MIRAGE, PATH, UCDB, _drop_extension, alert, assign, badge, cwd_abspath, cwd_relpath, debug, echo, glob, help, here_abspath, info, isa, jr, log, project_abspath, rpr, type_of, types, urge, validate, warn, whisper;
